        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="/get-started"
                className="w-full sm:w-auto flex items-center justify-center bg-white text-emerald-900 px-8 py-4 rounded-xl font-semibold shadow-lg hover:shadow-xl hover:bg-emerald-50 transition-all duration-300 text-lg"
              >
                {t('hero_cta')}
            ...
            <div className="mt-6">
              ...
              >
                ...
                <span className="underline">{t('hero_find_help')}</span>
              </a>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="absolute -bottom-6 -left-6 bg-white text-emerald-900 rounded-2xl p-6 shadow-xl">
              ...
              <div className="text-sm text-slate-600">{t('benefit_free')}</div>
            </div>
          </motion.div>
        </div>
      </div>
