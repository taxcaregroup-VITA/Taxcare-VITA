...
export default function HeroSection() {
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm font-medium">
                Trusted by hundreds of taxpayers
              </span>
            </div>
            ...
            <p className="text-xl text-emerald-100 mb-8 max-w-xl">
              IRS-certified VITA volunteers prepare your taxes 100% free —
  ...
  <Link
    to="/get-started"
    className="inline-flex items-center justify-center bg-white text-emerald-900 font-semibold px-8 py-4 rounded-xl shadow-lg hover:bg-emerald-50 transition"
  >
    Get Started
    <ArrowRight className="ml-2 h-5 w-5" />
            ...
            <div className="mt-6">
              <a
                ...
                className="inline-flex items-center gap-2 text-emerald-200 hover:text-white transition"
              >
                <MapPin className="h-4 w-4" />
                <span className="underline">
                  Find in-person VITA help
                </span>
              </a>
            </div>
          </motion.div>
